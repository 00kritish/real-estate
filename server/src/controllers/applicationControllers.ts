...
export const createApplication = async (
    ...
    try {
        ...
        res.status(201).json(newApplication);//sending to the frontend from res.json()
    } catch (error: any) {
        res
            .status(500)
...
export const updateApplicationStatus = async (
    ...
    try {
        ...
        res.json(updatedApplication);//updated application sended to frontend from res.json
    } catch (error: any) {
        res
            .status(500)
